...
@Component({
  ...
  templateUrl: './ritmo-cardiaco.component.html',
  styleUrls: ['./ritmo-cardiaco.component.css']
})
export class RitmoCardiacoComponent implements OnInit {

  infoSensorSmartphone: string[] = ['sensorRitmoCardiaco', 'Ritmo Cardíaco']
